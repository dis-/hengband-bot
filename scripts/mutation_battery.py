...
PUBLIC_TESTS = frozenset(
    {
        ...
        "test_policy_fundraising.IdleItemDepositTest.test_gate1_five_diggers_compose_sales_for_only_the_three_worst",
        "test_policy_supply.HiddenInfoFallbackTest.test_a21_home_device_prevents_affordable_purchase",
        "test_policy_supply.HiddenInfoFallbackTest.test_a21_fresh_home_absence_falls_through_once",
        "test_policy_supply.HiddenInfoFallbackTest.test_shortage_purchase_is_home_first_too",
        "test_policy_supply.HiddenInfoFallbackTest.test_a21_unaffordable_device_composes_surplus_sale_before_stop",
        "test_policy_supply.HiddenInfoFallbackTest.test_a21_unroutable_home_never_rearms_magic_entry_loop",
        "test_policy_supply.HiddenInfoFallbackTest.test_a21_unroutable_home_blocks_before_magic_entry",
...
def run_tests(package_parent: Path, full_suite: bool) -> dict:
    ...
    env["HENGBOT_RUNTIME_DIR"] = str(package_parent / "runtime")
    proc = subprocess.run(
