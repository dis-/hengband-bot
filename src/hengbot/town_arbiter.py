...
class TownTurnArbiter:
    ...
    def __init__(self, budgets: Mapping[str, tuple[tuple[str, ...], int]]) -> None:
        ...
        registrations = (
            ...
            registration("shop-buy", ("shop:one-shot-buy", "shop:one-shot-in-flight", "shop:one-shot-page-not-zero", "shop:one-shot-acquire-refused", "shop:buy", "shop:await-", "shop:observe", "shop:home-first-before-purchase", "shop:store-context-exit", "town:wait-restock"), "gold down and inventory delta"),
