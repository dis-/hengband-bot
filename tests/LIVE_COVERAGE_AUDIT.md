...
2026-09-08 structural note: Phase 11a re-parented the shop/purchase/sell
coverage from `TownAndFundraisingPolicyTest` into
`ShopPurchaseSellPolicyTest`; the historical verification paragraph above
retains the class name that was accurate when that evidence was recorded.
2026-08-17 evidence loss: skipped `test_frozen_q34_town_damage_replay_steps_away_on_each_hp_drop`, `test_frozen_q34_offer_is_stable_across_mapless_store_snapshot`, `test_frozen_armed_q34_board_rejects_fundraising_and_leaves_home_cycle`, `test_ninth_strike_archive_opening_claim_gate_and_decisions`, `test_ninth_strike_archive_finished_q34_restores_claims_unchanged`, `test_ninth_strike_archive_opening_hunger_precedes_claim_gate`, `test_finished_q34_capture_releases_fundraising_start_and_claims`, `test_frozen_cl30_confirmation_damage_replay_reuses_teleport`, `test_frozen_home_whiff_falls_back_after_two_followup_decisions`, `test_real_west_pocket_replay_retires_goal_and_plans_elsewhere`, `test_real_exploration_giveup_relocates_to_western_window_edge`, and `test_window_edge_replay_reaches_new_coverage_and_resets_stall` because their destroyed source artifacts cannot be reconstructed without inventing replay state.
