"""Freeze the 2026-09-16 calibration/redress incident byte-for-byte."""
...
def main() -> None:
    ...
    if len(selected) != 58 or turns[0] != FIRST_TURN or turns[-1] != LAST_TURN:
        raise AssertionError(f"recorded calibration window changed: {turns!r}")
