"""Freeze the 2026-09-16 quest-carry stockout incident byte-for-byte."""
...
TARGET = ROOT / "tests" / "fixtures" / "quest-carry-departure-20260916.jsonl.gz"
...
def main() -> None:
    ...
    if len(selected) != 150 or turns[0] != FIRST_TURN or turns[-1] != LAST_TURN:
        raise AssertionError(f"recorded quest-carry window changed: {turns!r}")
